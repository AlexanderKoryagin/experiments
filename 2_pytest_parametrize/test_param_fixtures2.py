# http://stackoverflow.com/questions/22171681/pytest-parameterized-test-with-cartesian-product-of-arguments
...
@pytest.mark.parametrize(
    'number,vowel,consonant', itertools.product(numbers, vowels, consonants))
